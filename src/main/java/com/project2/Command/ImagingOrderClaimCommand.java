...
public class ImagingOrderClaimCommand implements Command {
    private final NotificationService notificationService;
    private final CommandLog commandLog;
    private final Order order;

    public ImagingOrderClaimCommand(Order order, NotificationService notificationService, CommandLog commandLog) {
        this.order = order;
