...
public class MedicationOrderClaimCommand implements Command {
    private final NotificationService notificationService;
    private final CommandLog commandLog;
    private final Order order;

    public MedicationOrderClaimCommand(Order order, NotificationService notificationService, CommandLog commandLog) {
        this.order = order;
