...
public class ImagingOrderSubmitCommand implements Command {
    ...
    public ImagingOrderSubmitCommand(Order order, TriagingEngine triagingEngine, OrderAccess orderAccess, NotificationService notificationService, CommandLog commandLog) {
