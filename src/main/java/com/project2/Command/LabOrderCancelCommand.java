...
public class LabOrderCancelCommand implements Command {
    ...
    public LabOrderCancelCommand(Order order, OrderAccess orderAccess, NotificationService notificationService, CommandLog commandLog, TriagingEngine triagingEngine) {
