...
public class ImagingOrderCompleteCommand implements Command {
    ...
    public ImagingOrderCompleteCommand(Order order, NotificationService notificationService, CommandLog commandLog, OrderAccess orderAccess, TriagingEngine triagingEngine) {
        this.order = order;
