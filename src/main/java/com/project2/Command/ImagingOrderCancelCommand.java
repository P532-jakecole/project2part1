...
public class ImagingOrderCancelCommand implements Command {
    ...
    public ImagingOrderCancelCommand(Order order, OrderAccess orderAccess, NotificationService notificationService, CommandLog commandLog, TriagingEngine triagingEngine) {
